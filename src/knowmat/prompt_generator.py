...
def generate_system_prompt(sub_field: Optional[str] = None) -> str:
    ...
    return (
        ...
        "1. **source_doi**: Extract the paper's DOI from anywhere in the text (abstract, header, references).\n"
        ...
        "6. **process_category**: Classify the manufacturing process into ONE category:\n"
        ...
        "7. **measurement_condition** for properties: ALWAYS start with test temperature in Kelvin.\n"
        ...
        "8. **role**: Classify each composition's role in the paper.\n"
