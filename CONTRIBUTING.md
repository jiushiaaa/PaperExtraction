...
Welcome to `KnowMat` contributor's guide.
...
If you experience bugs or general issues with `KnowMat`, please have a look
...
You can help improve `KnowMat` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`KnowMat` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `KnowMat`'s files. While this mechanism can
...
```
conda create -n KnowMat python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/KnowMat.git
   cd KnowMat
   ```
...
5. Install [pre-commit]:
   ...
   `KnowMat` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/KnowMat
[issue tracker]: https://github.com/<USERNAME>/KnowMat/issues
